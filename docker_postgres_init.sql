...
CREATE TABLE todolist (
	...
	todolist_status CHAR(1) NOT NULL DEFAULT 'p',
	...
	FK_todolist_user_id INT REFERENCES users(user_id)
...
CREATE TABLE lists (
	...
	lists_status CHAR(1) NOT NULL DEFAULT 'p',
	PRIMARY KEY(lists_id),
	FK_lists_user_id INT REFERENCES users(user_id),
	FK_lists_category_id INT REFERENCES category(category_id),
...
('admin02','$2b$10$1HQhK6BAUpP.pOfwpTmRbuJaG0pTiAVE2bOi50qprFS.UvpngPO/G','admin2@email.com',true,'u')
