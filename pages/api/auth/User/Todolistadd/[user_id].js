...
async function todolistadd(req,res) {
    ...
    try{
        ...
        const category_user_id = await conn('SELECT fk_category_id , fk_todolist_user_id FROM todolist WHERE todolist_id = $1',[todolist_id[0].todolist_id])
        ...
        // console.log(Data)
        res.status(200).json({Data:"Add todolist success!!!",todolist_id:todolist_id[0].todolist_id,category_user_id:category_user_id[0]})
