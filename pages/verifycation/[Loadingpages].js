            ...
            <div className="loading-con">
                {Load
                    ...
                    {Status==200
                        ?(<>
                        <h1>{posts}</h1>
                        <h1 className="success-verify">
                            ✓
                        </h1>
                        <h2><a href='http://localhost:3000/Login'>Click hear to login</a></h2>
                        </>)
                        :(<>
                            <h1>{posts}</h1>
                            <h1 className="unsuccess-verify">
                                𐄂
                            </h1>
                            <h2><a href='http://localhost:3000/Register'>Click hear to Register</a></h2>
                            </>)
                    }
                    </>)
                }
